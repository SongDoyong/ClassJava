...
//		for(String s:title)
//		{
//			if(s.contains(fd))			// 검색어 (fd)가 포함됐다면,,
//			{
//				System.out.println(s); 	// 그 s(title)값을 가져와라
//			}
//		}
		Scanner scan = new Scanner(System.in);
		while(true)
